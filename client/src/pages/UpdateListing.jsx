...
export default function UpdateListing() {
    ...
    // this is the new thing we need in this page. to get data from this url the way in app we said
    //         <Route path='/update-listing/:listingId' element={<UpdateListing />} />
    useEffect(() => {
        const fetchListing = async () => {
            const listingId = params.listingId; // as we called it in App.jsx
        ...
        fetchListing();
    }, []); // the [] is that it must only happen once. else it will keep rerendering
