...
export default function Profile() {
  ...
  // now we are working on the listings
  ...
  // listing id was  our button input
      ...
      <div className='flex flex-col gap-4'>
        ...
        <div className='border rounded-lg p-3 flex justify-between items-center gap-4' key={listing._id}>
          ...
          <Link to={`/listing/${listing._id}`}  className='text-slate-700 font-semibold flex-1 hover:underline truncate'>
            {/* the flex-1 makes it go from one end to another */}
            <p>{listing.name}</p>
          </Link>
          <div className='flex flex-col'>
            {/* if you dont give it as an arrow function this method will always be done even when you dont want. */}
